...
import { MENU_ITEMS, MENU_ITEM_VARIANTS, SIDEBAR_VARIANTS } from './constants';
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <motion.div
      ...
      className="h-full bg-slate-900 rounded-3xl shadow-sm flex flex-col overflow-hidden"
    >
      {/* Logo & Toggle */}
          ...
          <AnimatePresence>
            {!collapsed && (
              ...
              >
                ...
                <div className="text-slate-400 text-xs">admin@bento.app</div>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
