...
public enum ErrorCode {
    ...
    USERNAME_ALREADY_EXISTS(3011, "Tên đăng nhập đã tồn tại"),
    EMAIL_ALREADY_EXISTS(3012, "Email đã được sử dụng"),
    EMAIL_REQUIRED(3013, "Email không được để trống"),
    EMAIL_INVALID(3014, "Email không hợp lệ"),
    FULL_NAME_REQUIRED(3015, "Họ và tên không được để trống"),
    USERNAME_INVALID_LENGTH(3016, "Tên đăng nhập phải từ 3 đến 50 ký tự"),
    PASSWORD_INVALID_LENGTH(3017, "Mật khẩu phải từ 6 đến 100 ký tự"),
    FULL_NAME_INVALID_LENGTH(3018, "Họ và tên không được vượt quá 100 ký tự"),
    USER_ALREADY_ACTIVE(3019, "Tài khoản đã được kích hoạt"),
    USER_PENDING_ACTIVATION(3020, "Tài khoản chưa được kích hoạt. Vui lòng kiểm tra email."),
    ;
